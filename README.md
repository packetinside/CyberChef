...
CyberChef는 영국 정보기관인 GCHQ(Government Communications Headquarters)에서 개발한 데이터 분석 및 변환을 위한 웹 기반 오픈 소스입니다. 
...
아래 링크를 통해서 라이브 데모를 할 수도 있고, 로컬에서 인터넷 연결 없이도 사용이 가능합니다.
